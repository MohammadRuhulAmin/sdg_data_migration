query="""
        ...
        tmp.geo_division_id,tmp.geo_district_id,tmp.geo_upazila_id
        ...
        sidc.status,sidc.publish,sid.created,sid.modified,sidc.geo_division_id,sidc.geo_district_id,
        sidc.geo_upazila_id 
